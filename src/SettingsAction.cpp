    ...
    _pointOpacityAction(this, "Opacity", 0.f, 1.f, 0.75f, 2)
{
    ...
    connect(&_pointSizeAction, &DecimalAction::valueChanged, _DVRViewPlugin, &DVRViewPlugin::renderData);
    connect(&_pointOpacityAction, &DecimalAction::valueChanged, _DVRViewPlugin, &DVRViewPlugin::renderData);
