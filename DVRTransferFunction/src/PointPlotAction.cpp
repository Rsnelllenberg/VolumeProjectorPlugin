...
void PointPlotAction::initialize(TransferFunctionPlugin* transferFunctionPlugin)
{
    ...
    connect(&_transferFunctionPlugin->getPositionDataset(), &Dataset<Points>::changed, this, [this]() {
        ...
        updateTransferFunctionWidgetPointSizeScalars();
        updateTransferFunctionWidgetPointOpacityScalars();
    ...
    connect(&_transferFunctionPlugin->getPositionDataset(), &Dataset<Points>::childAdded, this, &PointPlotAction::updateDefaultDatasets);
    connect(&_transferFunctionPlugin->getPositionDataset(), &Dataset<Points>::childRemoved, this, &PointPlotAction::updateDefaultDatasets);
    connect(&_transferFunctionPlugin->getPositionDataset(), &Dataset<Points>::dataSelectionChanged, this, &PointPlotAction::updateTransferFunctionWidgetPointSizeScalars);
    connect(&_transferFunctionPlugin->getPositionDataset(), &Dataset<Points>::dataSelectionChanged, this, &PointPlotAction::updateTransferFunctionWidgetPointOpacityScalars);

    connect(&_sizeAction, &ScalarAction::magnitudeChanged, this, &PointPlotAction::updateTransferFunctionWidgetPointSizeScalars);
    connect(&_sizeAction, &ScalarAction::offsetChanged, this, &PointPlotAction::updateTransferFunctionWidgetPointSizeScalars);
    connect(&_sizeAction, &ScalarAction::sourceSelectionChanged, this, &PointPlotAction::updateTransferFunctionWidgetPointSizeScalars);
    connect(&_sizeAction, &ScalarAction::sourceDataChanged, this, &PointPlotAction::updateTransferFunctionWidgetPointSizeScalars);
    connect(&_sizeAction, &ScalarAction::scalarRangeChanged, this, &PointPlotAction::updateTransferFunctionWidgetPointSizeScalars);

    connect(&_opacityAction, &ScalarAction::magnitudeChanged, this, &PointPlotAction::updateTransferFunctionWidgetPointOpacityScalars);
    connect(&_opacityAction, &ScalarAction::offsetChanged, this, &PointPlotAction::updateTransferFunctionWidgetPointOpacityScalars);
    connect(&_opacityAction, &ScalarAction::sourceSelectionChanged, this, &PointPlotAction::updateTransferFunctionWidgetPointOpacityScalars);
    connect(&_opacityAction, &ScalarAction::sourceDataChanged, this, &PointPlotAction::updateTransferFunctionWidgetPointOpacityScalars);
    connect(&_opacityAction, &ScalarAction::scalarRangeChanged, this, &PointPlotAction::updateTransferFunctionWidgetPointOpacityScalars);
}
...
void PointPlotAction::updateDefaultDatasets()
{
    ...
    auto positionDataset = Dataset<Points>(_transferFunctionPlugin->getPositionDataset());
...
void PointPlotAction::updateTransferFunctionWidgetPointSizeScalars()
{
    if (_transferFunctionPlugin == nullptr)
        return;
    ...
    const auto numberOfPoints = _transferFunctionPlugin->getPositionDataset()->getNumPoints();
    ...
    if (_sizeAction.isSourceDataset()) {
        ...
        if (pointSizeSourceDataset.isValid() && pointSizeSourceDataset->getNumPoints() == _transferFunctionPlugin->getPositionDataset()->getNumPoints())
        {
    ...
    _transferFunctionPlugin->getTransferFunctionWidget().setPointSizeScalars(_pointSizeScalars);
}

void PointPlotAction::updateTransferFunctionWidgetPointOpacityScalars()
{
    if (_transferFunctionPlugin == nullptr)
        return;
    ...
    if (_opacityAction.isSourceDataset()) {
        ...
        if (pointOpacitySourceDataset.isValid() && pointOpacitySourceDataset->getNumPoints() == _transferFunctionPlugin->getPositionDataset()->getNumPoints()) {
    ...
    _transferFunctionPlugin->getTransferFunctionWidget().setPointOpacityScalars(_pointOpacityScalars);
}
